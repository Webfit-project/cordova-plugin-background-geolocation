...
public class Config implements Parcelable
{
  ...
  public static final int ANDROID_WEBFIT_PROVIDER = 2;
  ...
  public String toString () {
    return new StringBuffer()
      ...
      .append(" minBattery=").append(getMinBattery())
      .append("]")
      .toString();
  }
  ...
  public static Config fromJSONObject (JSONObject jObject) throws JSONException {
    ...
    config.setMinBattery(jObject.optInt("minBattery", config.getMinBattery()));
    return config;
  }
  ...
  public JSONObject toJSONObject() throws JSONException {
    ...
    json.put("minBattery", getMinBattery());
    return json;
  }
}
